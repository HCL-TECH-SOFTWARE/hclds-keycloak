            ...
            <#if passwordRequired??>
                <div class="${properties.kcFormGroupClass!}">
                    <div class="${properties.kcLabelWrapperClass!}">
                        ...
                        <#if locale?? && locale.currentLanguageTag = 'ar'>style="float: right;"<#elseif locale?? && locale.currentLanguageTag = 'he'> style="float: right;"</#if>>${msg("password")}</label>
                    </div>
                    <div class="${properties.kcInputWrapperClass!}">
                ...
                <div class="${properties.kcFormGroupClass!}">
                    <div class="${properties.kcLabelWrapperClass!}">
                        <label for="password-confirm"
                               ...
                               <#if locale?? && locale.currentLanguageTag = 'ar'>style="float: right;"<#elseif locale?? && locale.currentLanguageTag = 'he'> style="float: right;"</#if>>${msg("passwordConfirm")}</label>
                    </div>
                    <div class="${properties.kcInputWrapperClass!}">
